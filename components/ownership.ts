...
export const PENICILLIN_UNLOCKABLES = ["TOKEN_OUTFIT_REWARD_HERO_PEN_COAT_SUIT"]

export const PENICILLIN_ITEMS_UNLOCKABLES = [
...
export const SPORT_UNLOCKABLES = [
    "TOKEN_OUTFIT_REWARD_HERO_SPORTSPACK_COACH",
    "TOKEN_OUTFIT_REWARD_HERO_SPORTSPACK_JERSEY02",
    "TOKEN_OUTFIT_REWARD_HERO_SPORTSPACK_JERSEY03",
    "PROP_CONTAINER_SUITCASE_SPORTSPACK_A",
    "TOKEN_PROP_MELEE_FIBERWIRE_SPORTSPACK_MEDAL_A",
    "TOKEN_PROP_MELEE_SPORTSPACK_TROPHY_A",
    "FIREARMS_SNIPER_SPORTSPACK_RIFLE_A",
    "FIREARMS_HERO_PISTOL_SPORTSPACK_AIR_A",
    "TOKEN_PROP_DEVICE_SPORT_A_RUBBERDUCK_REMOTE_KNOCKDOWN",
]

export const POMADA_UNLOCKABLES = [
    "TOKEN_OUTFIT_REWARD_HERO_POMADA_ZIGZAGSUIT",
    "FIREARMS_HERO_RIFLE_TAC_4_AUTO_POMADA",
    "PROP_GADGET_DISTRACTION_RADIO_POMADA",
    "PROP_MELEE_KNIFE_POMADA",
]

export const EG04_UNLOCKABLES = [
    "TOKEN_OUTFIT_REWARD_HERO_EG04_DLC_A",
    "TOKEN_OUTFIT_REWARD_HERO_EG04_DLC_B",
    "TOKEN_OUTFIT_REWARD_HERO_EG04_DLC_C",
    "FIREARMS_HERO_SNIPER_EG04",
    "FIREARMS_HERO_PISTOL_EG04",
    "TOKEN_PROP_MELEE_EG04_SUNCREAM",
    "TOKEN_PROP_MELEE_EG04_WATER_BALLOON",
    "PROP_CONTAINER_SUITCASE_EG04_A",
    "TOKEN_PROP_MELEE_EG04_CROQUET_MALLET",
]

export const GREENTINI_UNLOCKABLES = [
    "TOKEN_OUTFIT_REWARD_HERO_GREENTINI_DLC_A",
    "TOKEN_OUTFIT_REWARD_HERO_GREENTINI_DLC_B",
    "FIREARMS_HERO_PISTOL_TACTICAL_ICA_19_FA_STEALTH_GREENTINI",
    "PROP_CONTAINER_SUITCASE_GREENTINI_A",
    "TOKEN_PROP_TOOL_GREENTINI_COOKIE_A",
    "PROP_MELEE_GREENTINI_MICROPHONE_A",
]
